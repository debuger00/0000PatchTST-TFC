...
import yaml
from models.convtran import Configs
...
def save_hyperparameters(args, model_configs, save_path):
    ...
    hyperparameters = {
        ...
        '######model_ emb_size': model_configs.emb_size,
        '######model_num_heads': model_configs.num_heads,
        '######model_dim_ff': model_configs.dim_ff,
        ...
        'loss_ratio':args.loss_ratio,
        # 模型超参数
        'model_channel_size': model_configs.channel_size,
        'model_seq_len': model_configs.seq_len,
        'model_emb_size': model_configs.emb_size,
        'model_num_heads': model_configs.num_heads,
        'model_dim_ff': model_configs.dim_ff,
        'model_Fix_pos_encode': model_configs.Fix_pos_encode,
        'model_Rel_pos_encode': model_configs.Rel_pos_encode,
        'model_dropout': model_configs.dropout
...
if __name__ == '__main__':
    ...
    parser.add_argument('--net', type=str, default='ConvTrans', help='net type  PatchTST_wyh, GTN')
...
#     wandb.agent(sweep_id, function=train)
    ...
    with torch.no_grad():
        ...
        torch.save(test_target, os.path.join(checkpoint_path, 'test_target.pt'))
        torch.save(test_predict, os.path.join(checkpoint_path, 'test_predict.pt'))
