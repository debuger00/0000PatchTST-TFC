...
if __name__ == "__main__":
    ...
    checkpoint_path = "../experiments_logs/AAR_2_AAR/run1/pre_train_seed_42_2layertransformer/saved_models/ckp_last.pt"
    print_model_weights_shape(checkpoint_path)

    export_path = "../experiments_logs/AAR_2_AAR/run1/pre_train_seed_42_2layertransformer/saved_models/encoder_t_weights.pt"
    export_encoder_t_weights(checkpoint_path, export_path)
    print("#"*100)
    weights_path = "../experiments_logs/AAR_2_AAR/run1/pre_train_seed_42_2layertransformer/saved_models/encoder_t_weights.pt"
